      ...
      <div className="grid grid-cols-1 lg:grid-cols-12 gap-8">
        <div className="col-span-1 lg:col-span-12">
          <div className="bg-white rounded-2xl border border-slate-200 shadow-sm p-4 flex flex-wrap items-center gap-4">
            <h3 className="text-[10px] font-black text-slate-400 uppercase tracking-widest flex items-center gap-2 pr-4 shrink-0">
              <FolderKanban size={14} /> Selecionar Projeto
            </h3>
            <div className="flex-1 min-w-[250px]">
              ...
              >
                {projects.length === 0 && <option value="">Nenhum projeto criado</option>}
                {projects.map(p => (
