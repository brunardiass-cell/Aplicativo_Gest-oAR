            ...
            <div key={task.id} className={cardClasses}>
              ...
              <div className="flex justify-between items-start mb-4">
                <div className="flex flex-col gap-2">
                  <span className={`px-3 py-1 rounded-full text-[8px] font-black uppercase tracking-widest ${
                    ...
                    task.status === 'Pausado' ? 'bg-red-100 text-red-700' : 'bg-slate-100 text-slate-500'
                  }`}>
                    {task.status}
                  </span>
              ...
              <div className="space-y-1 mb-6">
                 <div className="flex justify-between items-end">
                    <span className="text-[8px] font-black text-slate-400 uppercase tracking-widest">Avanço</span>
              ...
              <div className="p-4 bg-slate-50 rounded-2xl border border-slate-100 mt-auto">
                 <p className="text-[8px] font-black text-brand-primary uppercase tracking-widest flex items-center gap-1.5 mb-1">
                ...
                <div className="mt-4 pt-3 border-t border-slate-100 flex items-center justify-between">
                  ...
                  {task.updates.length > 0 && (
                    <div className="flex items-center gap-1.5 text-brand-primary">
                       ...
                       <span className="text-[9px] font-black">{task.updates.length}</span>
                    </div>
                  )}
                </div>
              )}
