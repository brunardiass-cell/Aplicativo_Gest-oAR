  ...
  return (
    <div className="fixed inset-0 bg-slate-900/80 backdrop-blur-md z-[100] flex items-center justify-center p-4">
      <div className="bg-white rounded-[2rem] shadow-2xl w-full max-w-md overflow-hidden animate-in zoom-in-95 duration-200">
        <header className="p-8 bg-red-50 border-b border-red-100 flex items-center gap-4">
          <div className="bg-red-500 p-3 rounded-2xl text-white shadow-lg shadow-red-200">
            <AlertTriangle size={24} />
          </div>
          <div>
            <h2 className="text-xl font-black text-red-900 uppercase tracking-tighter">Ação Sensível</h2>
            <p className="text-[10px] font-bold text-red-600 uppercase tracking-widest">Protocolo de Exclusão</p>
          </div>
        </header>
        ...
        <footer className="p-8 bg-slate-50 border-t flex flex-col gap-3">
          <button
            onClick={handleConfirm}
            className="w-full py-4 bg-red-600 text-white rounded-2xl shadow-xl shadow-red-100 hover:bg-red-700 transition font-black uppercase text-xs tracking-widest flex items-center justify-center gap-2"
          >
