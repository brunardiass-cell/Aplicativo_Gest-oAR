    ...
    <div className="fixed inset-0 bg-slate-900/60 backdrop-blur-sm z-[70] flex items-center justify-center p-4">
      <div className="bg-white rounded-[2rem] shadow-2xl w-full max-w-lg overflow-hidden animate-in zoom-in-95 duration-200">
        <header className="p-8 bg-teal-50 border-b border-teal-100 flex items-center gap-4">
          <div className="p-3 bg-brand-primary rounded-2xl text-white shadow-lg shadow-teal-200">
            <FolderPlus size={24} />
          </div>
          <div>
        ...
        <div className="p-8 space-y-6">
          <div>
            ...
            <input 
              ...
              className="mt-1 w-full px-5 py-4 bg-slate-50 border border-slate-200 rounded-2xl text-sm font-bold text-black outline-none focus:ring-2 focus:ring-brand-primary"
            />
          </div>
          <div>
